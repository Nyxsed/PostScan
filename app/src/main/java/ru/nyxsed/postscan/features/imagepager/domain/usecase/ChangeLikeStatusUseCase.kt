...
class ChangeLikeStatusUseCase(private val vkRepository: VkRepository) {
    suspend operator fun invoke(contentEntity: ContentEntity) = vkRepository.changeLikeStatus(contentEntity)
}